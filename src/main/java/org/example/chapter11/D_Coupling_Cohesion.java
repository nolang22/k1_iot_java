...
/*  === 결합도(Coupling) VS 응집도(Cohesion) ===
    ...
    >> 모둘의 독립성을 결함도(Coupling)와 응집도(Cohesion)의 기준 단계로 측정
    ...
    - 낮은 응집도: 하나의 클래스가 너무 많은 일을 하거나, 관련없는 일을 하는 것
...
/*  cf) 의존성 추입(DI, Dependency Injection)
  ...
  - 개발자가 객체를 생성하는것이 아니라 프레임워크가 대신 처리해주는 것
...
public class D_Coupling_Cohesion {
    public static void main(String[] args) {
        ...
        StudentCohesion student = new StudentCohesion("이승승");
