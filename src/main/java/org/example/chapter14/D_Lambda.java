...
public class D_Lambda {
    public static void main(String[] args) {
        ...
        Calculator calculator2 = (a, b) -> {
            int result = a + b;
            return result; // 여러줄 구현은 {} 생략 불가!! (반환값도 반드시 return 사용)
        };
        System.out.println("람다식 결과1: " + calculator2.add(4, 4));
        ...
        NoParams noParams2 = () -> System.out.println("매개변수도 없고 반환겂도 없음");
        noParams2.sayHello();
